...
extern void gr_ct_destroy_func (GraphCoordTrans trans); /* do not use this function */
#define gr_ct_destroy(trans) (gr_ct_destroy_func(trans), trans=NULL) /* use this one */
